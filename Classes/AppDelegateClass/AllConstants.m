...
NSString *const METHOD_GET_FBID_PROFILEID=@"getFbIdProfileId";
NSString *const METHOD_GET_CREDIT_PACKAGES=@"getCreditPackages";
NSString *const METHOD_GET_USER_CREDIT_BALANCE=@"getUserCreditBalance";
NSString *const METHOD_GET_FUNDING_CAMPAIGNS=@"getFundingCampaigns";
NSString *const METHOD_GET_FUNDING_CAMPAIGNS_COUNT=@"getFundingCampaignsCount";
...
NSString *const METHOD_UPDATEMESSAGEFLAG=@"UpdateMessageflag";
NSString *const METHOD_GETMESSAGEDATA=@"GetMessageData";
...
NSString *const METHOD_GETPROFILE_PHOTOS = @"getUserPhotos";
NSString *const METHOD_GETPROFILE_PHOTOS_COUNT = @"getUserPhotosCount";
...
NSString *const METHOD_GETPROFILEMESSAGES=@"getMessages";
...
NSString *const PARAM_ENT_USER_PROFILE_ID=@"ent_user_profile_id";
