				 ...
				 subtitle:(BOOL)hasSubtitle
{
    ...
    if (type == JSBubbleMessageTypeOutgoing) {
        _imgCheckMark = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"checkmark1.png"]];
        UIImageView *img2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"checkmark1.png"]];
        [bubbleView addSubview:_imgCheckMark];
        [bubbleView addSubview:img2];
        [img2 setFrame:CGRectMake(bubbleView.frame.size.width-img2.frame.size.width+10, bubbleView.textView.center.y-(img2.frame.size.height/2)+25, img2.frame.size.width, img2.frame.size.height)];
        [_imgCheckMark setFrame:CGRectMake(img2.frame.origin.x, img2.frame.origin.y-4, img2.frame.size.width, img2.frame.size.height)];
    }
