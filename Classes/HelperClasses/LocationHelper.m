...
-(void)startLocationUpdating
{
    if (![CLLocationManager locationServicesEnabled])
    {
        ...
        [Helper showAlertWithTitle:@"Location Services disabled" Message:@"App requires location services to find your current city. Please enable location services in Settings."];
    }
    else
    {
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation
{
    ...
    if (currentLocation != nil) {
        ...
        if (blockDidUpdate) {
            blockDidUpdate(currentLocation,oldLocation,[NSError errorWithDomain:@"wishiz.me" code:90000 userInfo:[NSDictionary dictionary]]);
        }
    }
}
